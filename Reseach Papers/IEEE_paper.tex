...
\author{\IEEEauthorblockN{Saketh Pabbu, Nerella Venkata Sriram, Someswarkumar Balam}
...
The authors would like to thank the Department of Computer Science and Engineering at Indian Institute of Information Technology Sri City, Chittoor, Andhra Pradesh, for providing the necessary computational resources and research facilities. Special thanks to the AWS Educate program for providing cloud infrastructure support that enabled large-scale experimentation and deployment.
...
M.~Dorigo, M.~Birattari, and T.~Stutzle, \emph{Ant colony optimization}.\hskip 1em plus 0.5em minus 0.4em\relax New York: IEEE Press, 2006.

\bibitem{zhang2018load}
Q.~Zhang, L.~Cheng, and R.~Boutaba, ``Cloud computing: state-of-the-art and research challenges,'' \emph{Journal of Internet Services and Applications}, vol.~1, no.~1, pp. 7--18, 2010.

\bibitem{wang2019dynamic}
S.~C.~Wang, K.~Q.~Yan, W.~P.~Liao, and S.~S.~Wang, ``Towards a load balancing in a three-level cloud computing network,'' in \emph{2010 3rd International Conference on Computer Science and Information Technology}, vol.~1, 2010, pp. 108--113.

\bibitem{tesauro2006hybrid}
G.~Tesauro, ``Hybrid reinforcement learning for autonomic resource allocation,'' in \emph{Proceedings of the 3rd International Conference on Autonomic Computing}, 2006, pp. 65--73.

\bibitem{liu2020reinforcement}
N.~Liu, Z.~Li, J.~Xu, Z.~Xu, S.~Lin, Q.~Qiu, J.~Tang, and Y.~Wang, ``A hierarchical framework of cloud resource allocation and power management using deep reinforcement learning,'' in \emph{2020 IEEE International Parallel and Distributed Processing Symposium (IPDPS)}, 2020, pp. 658--668.

\bibitem{chen2021intelligent}
...
\bibitem{kaur2018hybrid}
R.~Kaur and P.~Luthra, ``Load balancing in cloud computing,'' in \emph{Proceedings of International Conference on Recent Advancement and Developments in Engineering and Technology}, 2018, pp. 1--4.
