...
from CC.load_balancer_workspace.server import initialize_servers
from CC.load_balancer_workspace.algorithms import round_robin_balancer, aco_balancer, initialize_pheromones, update_pheromones
from CC.load_balancer_workspace.hybrid import hybrid_balancer, reset_q_learning, get_q_table_status, get_exploration_rate
from CC.load_balancer_workspace.visualization import log_metrics, visualize_assignment_step, on_pick, analyze_and_plot, generate_simulation_id, current_simulation_id
from CC.load_balancer_workspace.workload_generator import workload_generator
...
class LoadBalancerUI:
    ...
    def start_simulation(self):
        ...
        try:
            ...
            # Initialize servers and algorithms
            self.servers = initialize_servers(self.num_servers)
